...
(function() {
    function initBackBtn() {
        ...
        popupButtons.style.cssText = 'position: absolute; display: flex; flex-direction: column; align-items: center; top: 70%; transform: translateY(-50%);';
...
for filepath in files_to_update:
    ...
    # We will use regex to find the block from <!-- GLOBAL BACK BUTTON & POPUP --> to </script>
