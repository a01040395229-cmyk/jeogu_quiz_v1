...
script_content = """<!-- GLOBAL BACK BUTTON & POPUP -->
<script>
(function() {
    function initBackBtn() {
        ...
        if (isScene1 || isScene2 || isQuiz2Screen1) {
            ...
            if (isScene1) {
                const els = [document.getElementById('signBubble'), document.querySelector('.background'), document.getElementById('bigJeogu1'), document.getElementById('quizScreen')];
                els.forEach(el => { if(el) observer.observe(el, config); });
            } else if (isScene2) {
                const els = [document.getElementById('bigJeogu1'), document.getElementById('quizScreen')];
                els.forEach(el => { if(el) observer.observe(el, config); });
            } else if (isQuiz2Screen1) {
...
for filepath in files_to_update:
    ...
    pattern = r'<!-- GLOBAL BACK BUTTON & POPUP -->.*?</script>'
    new_content = re.sub(pattern, script_content, content, flags=re.DOTALL)
