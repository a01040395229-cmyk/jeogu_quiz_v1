// Screen 1 Interactive Logic (Navigates to screen2.html on click)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initVoiceAndTyping() {
    ...
    const audioPath = encodeURI('sound/중국에서 베트남까지 택배를 15톤 운송하려고 해요.mp3');
  ...
  function startTypingMotion(parts) {
    ...
    function getTargetDurationMs() {
      ...
      return 3600; // Fallback estimate in ms
    }
  ...
  // Click stage to navigate to screen2.html
  if (gameContainer) {
    ...
    gameContainer.addEventListener('click', handleNextScreen);
    gameContainer.addEventListener('touchend', handleNextScreen);
  }
